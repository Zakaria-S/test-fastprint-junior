...
<body>
    <form method="post" action="/produk" class="mt-4 d-flex flex-column align-items-center justify-content-center">
        @csrf
        ...
        <div class="form-group mb-4">
            @foreach($statuses as $status)
                <input name="status_id" type="radio" value="{{$status->id_status}}" class="form-check-control">
